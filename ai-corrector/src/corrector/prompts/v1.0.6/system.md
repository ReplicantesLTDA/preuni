...
**IMPORTANTE — calibração do ceiling**: redações nota 1000 EXISTEM e são RECONHECÍVEIS pelos
sinais acima. Quando o aluno demonstra TODOS esses sinais, atribua 200 em CADA competência
correspondente. Descontar para 160 por preciosismo (ex.: "tem 1 ou 2 desvios pontuais" sendo
que matriz 200 permite até 2 desvios) é injusto com o aluno e quebra a calibração geral.
