defmodule Preuni.Emails.OtpLoginEmail do
  import Swoosh.Email
  ...
  @doc """
  Builds a passwordless login OTP email.
  ...
  defp render_html(otp) do
    ...
    <body style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 24px;">
      <h2 style="color: #6750A4;">Código de acesso</h2>
      <p>Use o código abaixo para entrar na sua conta PreUni. O código expira em <strong>15 minutos</strong>.</p>
