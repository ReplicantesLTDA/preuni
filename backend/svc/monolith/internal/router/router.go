...
import (
	...
	authrouter "github.com/preuni/svc/auth/router"
	"github.com/preuni/svc/monolith/internal/adapters"
	"github.com/preuni/svc/monolith/internal/config"
	"github.com/preuni/svc/monolith/internal/mail"
	userrepo "github.com/preuni/svc/user/repository"
	userrouter "github.com/preuni/svc/user/router"
)
