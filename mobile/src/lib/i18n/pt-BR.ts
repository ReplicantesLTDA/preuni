export const ptBR = {
  ...
  gamification: {
    ...
    medals: 'Suas medalhas',
    noMedalsYet: 'Nenhuma medalha ainda. Continue sua ofensiva para desbloquear!',
    tierBronze: 'Bronze',
    tierSilver: 'Prata',
    tierGold: 'Ouro',
    tierPlatinum: 'Platina',
    tierDiamond: 'Diamante',
    medalStreak7Day: 'Ofensiva de 7 dias',
    medalStreak30Day: 'Ofensiva de 30 dias',
    medalStreak100Day: 'Ofensiva de 100 dias',
    medalTierPromotion: 'Subiu de liga',
    medalWeeklyTopFinish: 'Primeiro lugar da semana',
  },
  social: {
    title: 'Amigos',
